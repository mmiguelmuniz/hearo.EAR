...
export const About: React.FC = () => {
  const pillars = [
    { title: 'Purpose', text: 'Strengthening our educational foundation for generations to come', icon: <Target size={40} color="#00337C" /> },
    { title: 'Vision', text: 'Creating excellence in education through strategic improvements', icon: <Sparkles size={40} color="#8b1d22" /> },
    { title: 'Legacy', text: 'Building a lasting impact that benefits current and future students', icon: <Users size={40} color="#00A8E8" /> },
  ];
      ...
      <div style={{ display: 'flex', gap: '20px', justifyContent: 'center', flexWrap: 'wrap' }}>
        {pillars.map((p, i) => (
          <motion.div 
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.5, delay: i * 0.2 }} // Delay cascata
            style={{ 
              padding: '40px', 
              borderRadius: '15px', 
